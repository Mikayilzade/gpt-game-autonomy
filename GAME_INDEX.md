...
| 002 | **TBD — active design cycle** | Phase 2 Concept Tournament / run 3 complete | TBD after design freeze | Not applicable | 36 seeds explored; uniform destructive pass completed; six semifinalists remain in `GAME2_TOURNAMENT.md`. |

## Current Game #002 semifinalists
- False Map Department
- Orbit Graffiti
- Pocket Weather War
- Echo Sculptor
- Creature Costume Inspector
- One-Room Convoy

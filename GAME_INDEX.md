...
| 016 | **ONE-WAY WORKSHOP** *(working title)* | **IN DESIGN / Phase 6 UX & Presentation complete / Phase 7 next** | TBD | NOT STARTED | Exact workbench/camera, mouse+controller/Deck navigation, capability language, irreversible commit UX, lineage Trace View, onboarding, accessibility, certifier/restart and OW01/11/20/24 walkthroughs frozen in `GAME16_UX.md`. |
...
Game #016 Phases 1–6 are complete. **ONE-WAY WORKSHOP** remains selected. Active design authority now includes `GAME16_UX.md`; next step is Phase 7 Economy / Retention / Commercial Model. The canonical campaign remains exactly 24 authored cases across Immediate Byproduct, Property Choice, Delayed Lineage, Cross-Blank Ancestry, Dual-Use Conflict and Derived Witness Relay. Rejected finalists Unpacking Order and Margin of Error remain tournament history only.

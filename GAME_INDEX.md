...
| 014 | **Negative Casting** *(working title)* | **IN DESIGN / Phase 5 Content Architecture complete / Phase 6 next** | TBD | NOT STARTED | 24-case floor frozen as 8 groups of 3; demo NC01–08; <=5 blockers on floor, three surfaces only late; canonical geometry separated from derived incidence/solution caches; authoring + human-route + anti-repetition gates defined. |

...
| 018 | **LOCAL TIME** *(working title)* | **IN DESIGN / Phase 4 mechanical architecture complete; Phase 5 next** | TBD | NOT STARTED | Canon now includes `GAME18_MECHANICS.md`: exact deterministic Resolve grammar, socket/overlap semantics, persistent/current causality, solver and anti-enumeration gates. |

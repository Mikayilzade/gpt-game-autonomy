...
| 007 | **Last Known Shape** *(working title)* | **IN DESIGN / Phase 3 product thesis locked / Phase 4 ready** | TBD | **NOT STARTED** | G7C02 selected after 3 tournament passes. Authored Observation Frames write persistent remembered physical form; no free-camera pixel authority. |
...
- repeated verb: OBSERVE/COMMIT exact candidate remembered form from an authored deterministic Observation Frame;
- when direct observation ends, last committed form becomes physically authoritative under global rules;
- depth from preservation/overwrite, conflicting affordances, authored masks/transforms, access self-block, two-object observation order and destructive re-observation;
- no arbitrary free-camera perspective authority, pixel/image recognition, precision alignment, combat or programming/timeline UI;

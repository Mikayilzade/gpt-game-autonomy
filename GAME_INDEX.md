...
| 014 | **Negative Casting** *(working title)* | **IN DESIGN / Phase 6 UX-Presentation complete / Phase 7 next** | TBD | NOT STARTED | 24-case floor / 8 groups; demo NC01–08; controller/handheld-first one-primary-surface UX; non-color target semantics; current-state-only contribution inspection; 3-surface late cases pass without solver overlays. |

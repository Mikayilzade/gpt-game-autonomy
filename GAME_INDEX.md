...
| 016 | **ONE-WAY WORKSHOP** *(working title)* | **IN DESIGN / Phase 7 commercial model complete / Phase 8 next** | TBD | NOT STARTED | $12.99 working MSRP, exact 24-case tray unlocks, OW01/03/05+D1 demo import, 3-level non-solver hints, 12 achievements, Steam/Deck/cloud baseline and monetization exclusions frozen in `GAME16_COMMERCIAL.md`. |
...
Game #016 Phases 1–7 are complete. **ONE-WAY WORKSHOP** remains selected. Active design authority now includes `GAME16_COMMERCIAL.md`; next step is Phase 8 Technical Implementation Specification. The canonical campaign remains exactly 24 authored cases across Immediate Byproduct, Property Choice, Delayed Lineage, Cross-Blank Ancestry, Dual-Use Conflict and Derived Witness Relay. Commercial progression is tiered with bounded branching and contains no currency/grind economy. Rejected finalists Unpacking Order and Margin of Error remain tournament history only.

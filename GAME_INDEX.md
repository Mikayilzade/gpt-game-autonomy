...
| 010 | **Luggage Carousel Zero** *(working title)* | **IN DESIGN / Phase 7 active** | TBD | NOT STARTED | Phases 1–6 complete; commercial/retention architecture active. |
...
- Phase 7: **active**. `GAME10_COMMERCIAL.md` freezes premium/no-live-service direction, $9.99–12.99 working price hypothesis (not final storefront price), one-skip act progression after strict A01–A03, optional minimum-tick Efficient Route, free seven-case demo with progress-transfer target, bounded achievements and no-grind retention philosophy.

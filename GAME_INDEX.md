...
| 016 | **ONE-WAY WORKSHOP** *(working title)* | **IN DESIGN / Phase 4 Mechanical Architecture complete / Phase 5 next** | TBD | NOT STARTED | Exact deterministic cut/child/lineage/jig/certifier contract frozen in `GAME16_MECHANICS.md`; normalized capability grammar and authoring validation gates ready for 24-case content architecture. |
...
Game #016 Phase 1, Phase 2 tournament, Phase 3 Product Thesis and Phase 4 Mechanical Architecture are complete. **ONE-WAY WORKSHOP** remains selected. Active design authority now includes `GAME16_MECHANICS.md`; next step is Phase 5 Content Architecture. Rejected finalists Unpacking Order and Margin of Error remain tournament history only.

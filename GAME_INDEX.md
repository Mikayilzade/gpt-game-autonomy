...
| 014 | **Negative Casting** *(working title)* | **IN DESIGN / Phase 8 technical specification complete / Phase 9 next** | TBD | NOT STARTED | Godot 4.7.x lead direction; exact integer/rational geometry; deterministic certifier; recoverable saves/demo import/cloud boundary; Phase 9 whole-game simulation next. |

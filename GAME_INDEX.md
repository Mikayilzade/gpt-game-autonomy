...
| 017 | **THE QUEUE KNOWS** *(working title)* | **IN DESIGN / Phase 9 whole-game simulation complete; Phase 10 next** | TBD | NOT STARTED | Full product lifecycle simulated in `GAME17_WHOLE_GAME_SIMULATION.md`; progression/evidence ambiguities repaired; adversarial review next. |
